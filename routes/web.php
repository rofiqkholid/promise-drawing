...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/update-profile', function () {
        return view('user_management.user_update');
    ...
    #region Reshare Management
    Route::get('/share/reshare-requests', [ShareController::class, 'getReshareRequests'])->name('share.reshare-requests');
    Route::post('/share/approve-reshare', [ShareController::class, 'approveReshare'])->name('share.approve-reshare');
    Route::post('/share/reject-reshare', [ShareController::class, 'rejectReshare'])->name('share.reject-reshare');
    #endregion
    ...
    Route::post('/api/receipts/request-reshare', [ReceiptController::class, 'requestReshare'])->name('receipts.request-reshare');
    #end region
