...
<script>
  ...
  $(function() {
    ...
    function loadKPI() {
      ...
      const allCards = '#cardTotal, #cardWaitingL1, #cardWaitingL2, #cardWaitingL3, #cardApproved, #cardRejected';
    ...
    function initTable() {
      table = $('#approvalTable').DataTable({
        ...
        scrollX: true,
        responsive: false,
        dom: '<"flex flex-col sm:flex-row justify-between items-center gap-4 p-2 text-gray-700 dark:text-gray-300"lf><"w-full overflow-x-auto"t><"flex flex-col sm:flex-row items-center justify-between mt-4 gap-4"<"text-sm text-gray-500 dark:text-gray-400"i><"flex justify-end"p>>',
        ajax: {
