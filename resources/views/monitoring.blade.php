...
<div id="dashboardWrapper" class="flex flex-col gap-2 w-full h-auto overflow-y-auto lg:h-[calc(100vh-70px)] lg:overflow-hidden custom-scrollbar pb-20 lg:pb-0">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-2 lg:gap-3 items-start">
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" id="date_range_input" class="block w-full rounded-xs border border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 focus:ring-0 focus:outline-none text-xs lg:text-sm py-1.5 lg:py-2 pl-8 lg:pl-10 pr-3">
                </div>
            </div>
            ...
            <h3 class="flex-none text-sm lg:text-lg font-semibold text-gray-800 dark:text-gray-100 mb-2 flex justify-between items-start">
                ...
                <div x-data="{ tooltipVisible: false }" class="relative">
                    ...
                    <div x-show="tooltipVisible"
                        style="display: none;"
                        class="absolute z-30 w-64 p-3 text-xs font-normal text-white bg-gray-900 dark:bg-black rounded-xs shadow-lg top-full right-0 mt-2">
    ...
    <div class="flex-none h-auto lg:h-[35vh] flex flex-col lg:flex-row gap-2 items-stretch mb-2">
            ...
            <div class="flex-none flex justify-between items-center mb-2">
                <h3 class="text-sm lg:text-lg font-semibold text-gray-800 dark:text-gray-100 flex items-center gap-2">
                    ...
                    <div x-data="{ tooltipVisible: false }" class="relative">
                        ...
                        <div x-show="tooltipVisible" style="display: none;" class="absolute z-30 w-64 p-3 text-xs font-normal text-white bg-gray-900 dark:bg-black rounded-xs shadow-lg top-full left-0 mt-2">
                ...
                <div x-data="{
                    ...
                    <button @click="open = !open" @click.outside="open = false" type="button"
                        class="flex items-center justify-between w-full px-2 lg:px-3 py-1 lg:py-1.5 text-xs lg:text-sm font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xs shadow-sm hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none">
                    ...
                    <div x-show="open" style="display: none;" class="absolute right-0 mt-2 w-full bg-white dark:bg-gray-800 rounded-xs shadow-xl border border-gray-100 dark:border-gray-600 py-1 z-50 max-h-48 overflow-y-auto custom-scrollbar">
        ...
        <div class="w-full lg:w-[25%] bg-white dark:bg-gray-800 rounded-xs border border-gray-200 dark:border-gray-700 shadow-sm flex flex-col p-3 lg:p-5 h-auto lg:h-full font-sans transition-all duration-300">
            ...
            <h3 class="text-sm lg:text-sm xl:text-lg font-bold text-gray-800 dark:text-gray-100 mb-2 lg:mb-1 xl:mb-2 flex justify-between items-start flex-shrink-0">
                ...
                <div x-data="{ tooltipVisible: false }" class="relative">
                    ...
                    <div x-show="tooltipVisible" style="display: none;" class="absolute z-30 w-64 p-3 text-xs font-normal text-white bg-gray-900 dark:bg-black rounded-xs shadow-lg top-full right-0 mt-2">
                        <div class="absolute w-3 h-3 bg-gray-900 dark:bg-black transform rotate-45 -top-1.5 right-2"></div>
            ...
            <div class="flex-1 w-full flex flex-col lg:flex-row items-center justify-center gap-4 lg:gap-2 xl:gap-4 py-2 lg:py-0">
                ...
                <div class="flex flex-col gap-2 lg:gap-2 xl:gap-3 w-full lg:flex-1 justify-center">
                    <div class="flex items-center p-1.5 lg:p-1 xl:p-1.5 rounded-xs bg-green-50 dark:bg-green-900/20 border border-green-100 dark:border-green-800">
                        <div class="w-8 h-8 lg:w-7 lg:h-7 xl:w-9 xl:h-9 flex-shrink-0 rounded-xs flex items-center justify-center text-green-600 dark:text-green-300">
                    ...
                    <div class="flex items-center p-1.5 lg:p-1 xl:p-1.5 rounded-xs bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-100 dark:border-yellow-800">
                        <div class="w-8 h-8 lg:w-7 lg:h-7 xl:w-9 xl:h-9 flex-shrink-0 rounded-xs flex items-center justify-center text-yellow-500 dark:text-yellow-300">
                    ...
                    <div class="flex items-center p-1.5 lg:p-1 xl:p-1.5 rounded-xs bg-cyan-50 dark:bg-cyan-900/20 border border-cyan-100 dark:border-cyan-800">
                        <div class="w-8 h-8 lg:w-7 lg:h-7 xl:w-9 xl:h-9 flex-shrink-0 rounded-xs flex items-center justify-center text-cyan-600 dark:text-cyan-300">
        ...
        <div class="w-full lg:w-[30%] h-[350px] lg:h-full bg-white dark:bg-gray-800 p-3 lg:p-4 rounded-xs border border-gray-200 dark:border-gray-700 flex flex-col overflow-hidden">
            <h3 class="flex-none text-sm lg:text-lg font-semibold text-gray-800 dark:text-gray-100 mb-2 flex justify-between items-start">
                <div class="flex items-center gap-2">
