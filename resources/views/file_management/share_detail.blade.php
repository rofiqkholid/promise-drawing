  ...
  <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
    ...
    <li aria-current="page">
      <div class="flex items-center">
        ...
        <a href="{{ route('file-manager.share') }}" class="text-sm font-semibold px-2.5 py-0.5 hover:text-blue-600 rounded-xs">
          Share Packages
        </a>
      </div>
    </li>
...
<div
  ...
  <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-6 items-start">
    ...
    <div class="lg:col-span-4 space-y-6">
      ...
      <!-- ===== Meta Card ===== -->
      <div x-ref="metaCard"
        class="self-start bg-white dark:bg-gray-800 rounded-xs border border-gray-200 dark:border-gray-700 overflow-hidden">
        <div class="px-4 py-3 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
          <div class="flex flex-col gap-4">
            ...
            @endphp
              ...
              <a href="{{ $backUrl }}"
                class="inline-flex items-center gap-1.5 px-3 py-2 text-xs font-medium text-gray-600 bg-white border border-gray-300 rounded-xs hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-gray-200 dark:border-gray-600">
            ...
            <div class="flex flex-wrap items-center gap-2">
              <button
                ...
                class="flex-1 inline-flex items-center gap-2 justify-center px-3 py-3 bg-blue-600 hover:bg-blue-700 text-white text-xs font-semibold rounded-xs transition-colors">
              ...
              <button
                @click="prepareZip()"
                class="flex-1 inline-flex items-center gap-2 justify-center px-3 py-3 bg-green-600 hover:bg-green-700 text-white text-xs font-semibold rounded-xs transition-colors">
                ...
                <div class="flex-1 min-w-0" :class="idx !== (pkg.activityLogs || []).length - 1 ? 'mb-6' : ''">
                  <div class="p-3 rounded-xs bg-gray-50 dark:bg-gray-900/40 border border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                    ...
                    <template x-if="item.snapshot && (item.snapshot.part_no || item.snapshot.ecn_no)">
                      <div class="mt-2 p-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-xs text-xs">
  ...
  <style>
    ...
    .preview-area {
      @apply bg-gray-100 dark:bg-gray-900/50 rounded-xs p-4 min-h-[20rem] flex items-center justify-center;
    }
