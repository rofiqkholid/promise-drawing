...
<div class="w-full px-2 sm:px-4 lg:px-6 xl:px-4 2xl:px-6">
    ...
    <div x-show="isLoadingRevision" x-transition x-cloak
        ...
        <div class="flex flex-col items-center gap-4 px-8 py-6 bg-white dark:bg-gray-800 rounded-xs border border-gray-200 dark:border-gray-700">
            <div class="relative w-12 h-12">
                <div class="absolute inset-0 border-4 border-blue-100 dark:border-blue-900/30 rounded-xs"></div>
                <div class="absolute inset-0 border-4 border-blue-600 border-t-transparent rounded-xs animate-spin"></div>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-6 items-start">
        ...
        <div class="lg:col-span-8">
            <div x-ref="refMainContainer"
                class="bg-white dark:bg-gray-800 rounded-xs border border-gray-200 dark:border-gray-700 overflow-hidden flex flex-col" style="min-height: 600px;">
...
<script>
    ...
    function toastSuccess(title = 'Success', text = '') {
        renderToast({
            icon: 'success',
            title,
            text
    ...
    function toastError(title = 'Error', text = '') {
        renderToast({
            icon: 'error',
            title,
            text
