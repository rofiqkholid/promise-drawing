...
<script>
    ...
    // Optimized Skeleton Loader logic
    function renderSkeletons(count = 8) {
        const row = `
            <tr class="animate-pulse">
                <td class="px-5 py-4 w-12 text-center"><div class="h-4 bg-gray-200 dark:bg-gray-700 rounded w-6 mx-auto"></div></td>
                <td class="px-5 py-4"><div class="space-y-2"><div class="h-4 bg-gray-200 dark:bg-gray-700 rounded w-48"></div><div class="h-3 bg-gray-100 dark:bg-gray-800 rounded w-32"></div></div></td>
                <td class="px-5 py-4"><div class="h-4 bg-gray-200 dark:bg-gray-700 rounded w-16 mx-auto"></div></td>
                <td class="px-5 py-4"><div class="h-4 bg-gray-200 dark:bg-gray-700 rounded w-20 mx-auto"></div></td>
                <td class="px-5 py-4"><div class="h-4 bg-gray-200 dark:bg-gray-700 rounded w-24 mx-auto"></div></td>
                <td class="px-5 py-4"><div class="h-4 bg-gray-200 dark:bg-gray-700 rounded w-16 mx-auto"></div></td>
                <td class="px-5 py-4"><div class="h-4 bg-gray-200 dark:bg-gray-700 rounded w-20"></div></td>
                <td class="px-5 py-4 text-center"><div class="h-6 bg-gray-200 dark:bg-gray-700 rounded-full w-16 mx-auto"></div></td>
                <td class="px-5 py-4 w-24 text-center"><div class="h-10 bg-gray-200 dark:bg-gray-700 rounded-xl w-10 mx-auto"></div></td>
            </tr>
        `;
    ...
    $(document).ready(function() {
        ...
        $('#fileTable tbody').html(renderSkeletons(8));
        ...
        let table = $('#fileTable').DataTable({
            ...
            ajax: {
                ...
                data: function(d) {
                    ...
                    d.search = {
                        value: $('#custom-upload-search').val()
                    };
                }
            },
            order: [
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        <button type="button" title="Manage Files" class="w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center rounded-sm bg-blue-50 text-blue-500 hover:bg-blue-100 hover:text-blue-600 transition-all duration-200 mx-auto border border-transparent" id="btn_manage_files_${row.id}" onclick="openPackageDetails('${row.id}')">
                            ...
                            <span id="spinner_manage_files_${row.id}" class="hidden animate-spin rounded-full h-4 w-4 border-b-2 border-current"></span>
                        </button>`;
                    }
                }
            ]
        ...
        $('.js-upload-filter').on('change', refreshData);
    ...
    function renderActivityLogs(logs) {
        ...
        logs.forEach((l, index) => {
            ...
            if (m.part_no || m.ecn_no) {
                contentHtml += `
                        <div class="mt-2 p-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded text-xs">
    ...
    window.openPackageDetails = function(id) {
        ...
        loaderOverlay.innerHTML = `<div class="bg-white dark:bg-gray-800 rounded-xs p-6 flex items-center gap-3"><div class="loader-border w-8 h-8 border-4 border-blue-400 rounded-full animate-spin"></div><div class="text-sm text-gray-700 dark:text-gray-300">Loading package details...</div></div>`;
            ...
            .then(json => {
                ...
                dialog.innerHTML = `
                        ...
                        <div class="p-4 bg-gray-50 dark:bg-gray-800/50 border-t border-gray-200 dark:border-gray-700 flex justify-end gap-3">
                            <button id="pkg-close-btn-2" class="inline-flex items-center gap-3 justify-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-xs text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-gray-200 dark:border-gray-600 dark:hover:bg-gray-600">
