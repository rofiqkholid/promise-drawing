...
<div class="w-full px-2 sm:px-4 lg:px-6 xl:px-4 2xl:px-6">
    <nav class="flex px-3 sm:px-5 py-2 sm:py-3 mb-3 text-gray-500 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 dark:text-gray-300 rounded-xs overflow-x-auto whitespace-nowrap hide-scrollbar" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <a href="{{ route('file-manager.upload') }}" class="text-xs sm:text-sm font-medium hover:text-blue-600 transition-colors">
                        Upload Management
                    </a>
                </div>
            </li>
                ...
                <div class="lg:col-span-12 space-y-8">
                    <div
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div x-show="pairedPartnerName" x-transition class="mt-2 p-2 bg-blue-50 dark:bg-blue-900/30 rounded-xs border border-blue-100 dark:border-blue-800 flex items-start">
                    ...
                    <div id="revision-options" x-show="isFormReady && !isReadOnly" x-transition.opacity
                        ...
                        <div x-show="revisionCheck.status === 'locked'" x-transition>
                            <div
                                class="p-4 rounded-xs bg-red-50 dark:bg-red-900/50 border border-red-200 dark:border-red-800">
                                <div class="flex items-center">
                        ...
                        <div x-show="revisionCheck.status === 'edit_draft'" x-transition>
                            <div
                                class="p-4 rounded-xs bg-blue-50 dark:bg-blue-900/50 border border-blue-200 dark:border-blue-800">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0">
                        ...
                        <div x-show="revisionCheck.status === 'create_new'" x-transition>
                            <div
                                class="p-4 rounded-xs bg-green-50 dark:bg-green-900/50 border border-green-200 dark:border-green-800">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <template x-for="cat in availableCategories" :key="cat.id">
                        <div x-show="isCategoryEnabled(cat.id)" x-transition:enter="transition ease-out duration-300"
                            ...
                            <div class="upload-card-container border border-gray-200 dark:border-gray-700 rounded-xs shadow-sm h-full flex flex-col bg-white dark:bg-gray-800"
                                ...
                                <div
                                    ...
                                    <span
                                        class="text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-300 px-2.5 py-0.5 rounded-xs">
                                ...
                                <div class="p-4 upload-area flex-grow flex flex-col" :id="`upload-area-${cat.id}`"
                                    ...
                                    <div class="file-list-container flex-grow min-h-0" :id="`file-list-${cat.id}`">
                                        ...
                                        <template x-for="fileWrapper in fileStores[cat.id].filter(f => !f.uploaded)"
                                            ...
                                            <div class="file-preview-item flex items-center space-x-3 p-2 rounded-xs">
                                                <div x-data="{ icon: getIcon(fileWrapper.name) }"
                                                    class="file-icon text-white w-10 h-10 flex items-center justify-center rounded-xs flex-shrink-0"
                                        ...
                                        <template x-for="fileWrapper in fileStores[cat.id].filter(f => f.uploaded)"
                                            :key="fileWrapper._uid">
                                            <div class="file-preview-item flex items-center space-x-3 p-2 rounded-xs">
                                                <div class="file-icon text-white w-10 h-10 flex items-center justify-center rounded-xs flex-shrink-0"
                                                    ...
                                                    <template
                                                        ...
                                                        <img :src="iconMap[fileWrapper.name.split('.').pop().toLowerCase()]"
                                                            alt="file icon" class="w-full h-full object-contain rounded-xs">
                                                    </template>
