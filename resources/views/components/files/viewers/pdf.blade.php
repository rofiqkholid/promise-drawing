...
<template x-if="isPdf(selectedFile?.name)">
    <div x-ref="viewport2d" class="relative w-full overflow-hidden bg-black/5 rounded"
        ...
        <div x-show="pdfLoading" x-transition.opacity.duration.300ms
            ...
            <div class="relative w-12 h-12 mb-4">
                ...
                <i class="fa-solid fa-file-pdf absolute inset-0 m-auto w-fit h-fit text-red-500 animate-pulse text-sm"></i>
            </div>

            <h3 class="text-sm font-bold text-gray-800 dark:text-gray-100 mb-2">Loading PDF</h3>
