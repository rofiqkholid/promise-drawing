    ...
    <div x-ref="viewport2d" class="relative w-full overflow-hidden bg-black/5 rounded"
        ...
        <div x-show="pdfLoading"
            ...
            <div class="relative w-16 h-16 mb-6">
                ...
                <i class="fa-solid fa-file-pdf absolute inset-0 m-auto w-fit h-fit text-red-500 animate-pulse text-xl"></i>
            </div>

            <h3 class="text-lg font-bold text-gray-800 dark:text-gray-100 mb-2">Loading PDF</h3>
