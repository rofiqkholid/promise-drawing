...
<template x-if="isTiff(selectedFile?.name)">
    <div x-ref="viewport2d" class="relative w-full overflow-hidden bg-black/5 rounded"
        ...
        <div x-show="tifLoading" x-transition.opacity.duration.300ms
            ...
            <div class="relative w-12 h-12 mb-4">
                ...
                <i class="fa-solid fa-file-image absolute inset-0 m-auto w-fit h-fit text-blue-500 animate-pulse text-sm"></i>
            </div>

            <h3 class="text-sm font-bold text-gray-800 dark:text-gray-100 mb-2">Processing TIFF</h3>
