    ...
    <div x-ref="viewport2d" class="relative w-full overflow-hidden bg-black/5 rounded"
        ...
        <div x-show="tifLoading"
            ...
            <div class="relative w-12 h-12 sm:w-16 sm:h-16 mb-4 sm:mb-6">
                ...
                <i class="fa-solid fa-file-image absolute inset-0 m-auto w-fit h-fit text-blue-500 animate-pulse text-lg sm:text-xl"></i>
            </div>

            <h3 class="text-xs sm:text-lg font-bold text-gray-800 dark:text-gray-100 mb-1.5 sm:mb-2">Processing TIFF</h3>
