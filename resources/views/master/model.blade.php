    ...
    <div class="relative p-4 w-full max-w-md h-full md:h-auto">
        <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <form id="addModelForm" action="{{ route('models.store') }}" method="POST">
                ...
                <div class="mb-4">
                    <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white text-left">Model Name <span class="text-red-600">*</span></label>
                ...
                <div class="mb-4">
                    <label for="status_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white text-left">Status <span class="text-red-600">*</span></label>
                ...
                <div class="mb-4">
                    <label for="planning" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white text-left">Planning (Qty) <span class="text-red-600">*</span></label>
    ...
    <div class="relative p-4 w-full max-w-md h-full md:h-auto">
        <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <form id="editModelForm" method="POST">
                ...
                <div class="mb-4">
                    <label for="edit_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white text-left">Model Name <span class="text-red-600">*</span></label>
                ...
                <div class="mb-4">
                    <label for="edit_status_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white text-left">Status <span class="text-red-600">*</span></label>
                ...
                <div class="mb-4">
                    <label for="edit_planning" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white text-left">Planning (Qty) <span class="text-red-600">*</span></label>
...
<script>
    $(document).ready(function() {
        ...
        function toastSuccess(t = 'Success', m = 'Operation success') {
            renderToast({
                icon: 'success',
                title: t,
                text: m
        ...
        function toastError(t = 'Error', m = 'Something went wrong') {
            BaseToast.update({
                timer: 3400
            });
            renderToast({
        ...
        $(document).on('click', '.close-modal-button', function() {
            hideModal($(this).closest('[id$="Modal"]'));
        });
        ...
        $('#confirmDeleteButton').on('click', function() {
            ...
            $.ajax({
                ...
                beforeSend: () => {
                    ...
                    setFormBusy($('#deleteModelModal'), true);
                },
                success: (data) => {
                    if (data.success) {
                        table.ajax.reload(null, false);
                ...
                complete: () => {
                    setButtonLoading($btn, false);
                    setFormBusy($('#deleteModelModal'), false);
                }
            });
        });
