        ...
        <ul>
            ...
            <li class="mb-2">
                ...
                <ul x-show="openMenu === {{ $menu->id }} && (sidebarOpen || hovering)" x-transition class="mt-1 pl-4 space-y-1 flex flex-col">
                    ...
                    <li>
                        <a href="{{ route($child->route) }}" class="flex items-center p-3 rounded-xs transition-colors duration-200 text-xs font-medium
                                                hover:bg-blue-50 hover:text-blue-800 dark:hover:bg-gray-800 dark:hover:text-gray-200
            ...
            @else
            <li class="mb-2">
                <a href="{{ route($menu->route) }}" class="flex items-center p-3 rounded-xs transition-colors duration-200 text-sm font-medium
                                hover:bg-blue-50 hover:text-blue-800 dark:hover:bg-gray-800 dark:hover:text-gray-200
